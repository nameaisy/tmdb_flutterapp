...
import 'package:tmdb_app/bloc/get_casts_bloc.dart';
import 'package:tmdb_app/model/cast.dart';
import 'package:tmdb_app/model/cast_response.dart';
      ...
      children: [
        SizedBox(
          ...
          child: CircularProgressIndicator(
            valueColor: new AlwaysStoppedAnimation<Color>(Color(0xFFF4EFEF)),
            strokeWidth: 4.0,
          ),
        )
      ],
